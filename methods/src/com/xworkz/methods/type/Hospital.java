...
public class Hospital {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Hospital) {
			...
			if (this.name.equals(hospital.name) && this.doctorName.equals(hospital.doctorName)
					&& this.doctorAge.equals(hospital.doctorAge) && this.doctorLocation.equals(hospital.doctorLocation)
